...
export class ViewServiceComponent implements OnInit {
  ...
  deleteService() {
    ...
    dialogRef.afterClosed()
      .subscribe(data => {
        if (data.success) {
          this.flashMessagesService.show('The service was successfully deleted', {
  ...
  addReview() {
    ...
    dialogRef.afterClosed()
      .subscribe(data => {
        if (data.success) {
          this.flashMessagesService.show('The review and rating were successfully added', {
            cssClass: 'alert-success',
            timeout: 5000
          });
  ...
  reqService() {
    ...
    this.requestService.newRequest(request)
      .subscribe(data => {
        if (data.success) {
          this.isReq = true;
          this.flashMessagesService.show('The service was successfully requested', {
            cssClass: 'alert-success',
            timeout: 5000
          });
        } else {
  ...
  cancelRequest() {
    ...
    this.requestService.cancelRequest(query)
      .subscribe(data => {
        if (data.success) {
          this.isReq = false;
          this.flashMessagesService.show('The item request was successfully cancelled', {
            cssClass: 'alert-success',
            timeout: 5000
          });
        } else {
